...
function CreateProposalForm() {
  ...
  const [formData, setFormData] = useState({
    ...
    venue: '',
    capacity: 50,
    organizationType: 'YOUTH_UNION', // DNA: Strict SRS Enum
    attachmentsJson: '[]' 
  });
  ...
  return (
    <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-sm border border-slate-200 overflow-hidden mb-10">
      {/* Header Styled per teammate request */}
      <div className="bg-[#1f5f89] p-8 text-white">
        <h2 className="text-3xl font-black tracking-tight">Submit Event Proposal</h2>
        <p className="text-blue-100/80 text-sm font-medium">Your proposal will be in the review queue. Please check "My Proposals" to update.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="p-8 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {/* Organization Type - Matched to SRS ENUMS */}
          <div className="space-y-1">
            ...
            >
              <option value="YOUTH_UNION">Youth Union (Đoàn Thanh niên)</option>
              <option value="STUDENT_ASSOCIATION">Student Association (Hội Sinh viên)</option>
            </select>
          </div>
        ...
        {/* Paperwork Upload Logic Integrated into style */}
        ...
        {/* Submit Button per teammate request */}
        <div className="pt-6">
          <button 
            type="submit"
